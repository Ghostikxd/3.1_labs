...
r6 = Record(amount=1140, comment='Баночка чипсов.', date='24.10.2022') 
...
print(cash_calculator.get_today_cash_remained('rub')) # Денег нет, держись: твой долг - 713.0 руб))
print(cash_calculator.get_today_stats()) #сколько потрачено денег сегодня: 1713 
print(cash_calculator.get_week_stats()) #сколько потрачено денег на этой неделе: 4713
...
print(calories_calculator.get_calories_remained()) #Сегодня можно съесть что-нибудь ещё, но с общей калорийностью не более 1230 кКал
print(calories_calculator.get_today_limit_balance()) #сколько осталось ккал до дневного лимита: 1230
print(calories_calculator.get_today_stats()) #сколько ккал получено сегодня: 1270
print(calories_calculator.get_week_stats()) #сколько ккал получено за неделю: 2410
